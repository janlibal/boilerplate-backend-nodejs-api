  ...
  afterEach(async () => {
    ...
    it('2. should throw an error if password is missing', (done) => {
        ...
        .end((err, res) => {
          ...
          res.body.should.have.property('message').eql('Request Validation Errors: Validation error')
...
describe('POST /api/v1/user', () => {
  ...
  it('6. should throw an error if password is missing', (done) => {
      ...
      .end((err, res) => {
        ...
        //res.body.message.should.have.property('Request Validation Errors: Validation error')
        //res.body.error.should.have.property('name').eql('RequestValidationErrors')
        done()
      })
  })
